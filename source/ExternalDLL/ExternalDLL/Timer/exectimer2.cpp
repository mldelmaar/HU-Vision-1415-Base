#ifndef _EXECTIMER_CPP_
#define _EXECTIMER_CPP_

#include "exectimer2.h"
#include <stdio.h>
#include <iostream>

/** The default constructor which initializes everything to zero.
 */
ExecTimer2::ExecTimer2() : BaseTimer2() {}
 ...
 */
bool ExecTimer2::run(std::string cmd, bool resout) {
	reset();
	start();
